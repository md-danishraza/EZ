...
export const Art1 = styled(DecorativeImage)`
  top: 15%;
  left: 0;
  width: 40px;
  transform: translateY(-50%);
...
export const Art2 = styled(DecorativeImage)`
  top: 0;
  right: 5%;
  width: 50px;
  @media (min-width: ${desktopBreakpoint}) {
...
export const Art3 = styled(DecorativeImage)`
  top: 50%;
  right: 0;
  width: 40px;
  @media (min-width: ${desktopBreakpoint}) {
...
export const Art4 = styled(DecorativeImage)`
  bottom: 10%;
  right: 0%;
  width: 40px;
  @media (min-width: ${desktopBreakpoint}) {
